...
4. **资产命名**：`Lumaris-Setup-x.y.z.exe`、`Lumaris-portable-x.y.z.zip`、`SHA256SUMS.txt`。
5. **草稿源**：`docs/release-notes/vX.Y.Z.md`；发版用 `gh release create -F docs/release-notes/vX.Y.Z.md`。

模板见：`docs/release-notes/TEMPLATE.md`。
